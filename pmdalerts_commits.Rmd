...
Figure \ref{fig:evolution} shows this evolution, in terms of PMD alerts per line of code, total PMD alerts and total lines of code. The smaller red dots are releases of minor versions. The bigger and labeled ones are major version releases.
